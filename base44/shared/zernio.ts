      ...
      properties: {
        ...
        appointment: {
          ...
          properties: {
            ...
            patient_email: { type: "string", description: "Email del paciente. Completá esto SOLO si tus instrucciones de objetivo te piden explícitamente recolectar el email Y el paciente ya te lo dio en esta conversación. Nunca lo pidas por tu cuenta si no está indicado en tus instrucciones." },
            patient_dni: { type: "string", description: "DNI del paciente. Completá esto SOLO si tus instrucciones de objetivo te piden explícitamente recolectar el DNI Y el paciente ya te lo dio en esta conversación. Nunca lo pidas por tu cuenta si no está indicado en tus instrucciones." },
          },
        },
      },
